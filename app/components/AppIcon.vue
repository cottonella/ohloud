...
const ICONS: Record<string, string> = {
  ...
  'rocket': '<path d="M8.8 11.5C7 12.3 5.9 14 5.6 16.4 6.8 16 7.9 15.8 8.8 15.7Z" fill="#FFB3A0" stroke="#E8734F" stroke-width="1.1"/><path d="M15.2 11.5C17 12.3 18.1 14 18.4 16.4 17.2 16 16.1 15.8 15.2 15.7Z" fill="#FFB3A0" stroke="#E8734F" stroke-width="1.1"/><path d="M12 2.4C9.6 4.2 8.5 6.8 8.5 10V15.7C8.5 16.5 9.1 17.1 9.9 17.1H14.1C14.9 17.1 15.5 16.5 15.5 15.7V10C15.5 6.8 14.4 4.2 12 2.4Z" fill="#EAF2FE" stroke="#5B8FC9" stroke-width="1.2"/><path d="M12 2.4C10.7 3.4 9.8 4.7 9.2 6.3H14.8C14.2 4.7 13.3 3.4 12 2.4Z" fill="#FFB3A0" stroke="#E8734F" stroke-width="1.05"/><circle cx="12" cy="9" r="1.7" fill="#BBD4F6" stroke="#5B8FC9" stroke-width="1.05"/><circle cx="10.75" cy="12.7" r="0.92" fill="#2C4A6E" stroke="none"/><circle cx="13.25" cy="12.7" r="0.92" fill="#2C4A6E" stroke="none"/><circle cx="11.05" cy="12.35" r="0.3" fill="#fff" stroke="none"/><circle cx="13.55" cy="12.35" r="0.3" fill="#fff" stroke="none"/><path d="M10.8 14.4c.7.6 1.7.6 2.4 0" stroke="#2C4A6E" stroke-width="0.95" fill="none" stroke-linecap="round"/><circle cx="9.6" cy="13.7" r="0.68" fill="#F49BC0" opacity="0.55" stroke="none"/><circle cx="14.4" cy="13.7" r="0.68" fill="#F49BC0" opacity="0.55" stroke="none"/><path d="M10.4 17.4C10.3 19.2 10.8 20.6 12 21.7 13.2 20.6 13.7 19.2 13.6 17.4Z" fill="#FCD97A" stroke="#F2A23B" stroke-width="1.05"/><path d="M11.3 17.5C11.3 18.7 11.5 19.6 12 20.3 12.5 19.6 12.7 18.7 12.7 17.5Z" fill="#F7975F" stroke="none"/>',
